                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="dealer_id">
                                                    <option value="1" <?php echo ($open_file->dealer_id == '1' ? 'selected="selected"':'');?>>Test</option>
                                                    <option value="2" <?php echo ($open_file->dealer_id == '2' ? 'selected="selected"':'');?>>Test 1</option>
                                                </select>
                                            </div>
                                            <div class="form-group">
