            ...
            <div class="col-md-12">
                <div class="row">
                    <div class="col-md-6 offset-md-3">
                        <div class="card">
                            <div class="card-body">
                                <form method="Post" action="<?php echo base_url().'admin/feature/add'?>" enctype="multipart/form-data" onsubmit="$('.preloader').show();">
                                    <div class="row">
                                        <div class="col-md-12">
                                    ...
                                    <br />
                                    <br />
                                    <button type="submit" name="add_feature" value="add_feature" class="btn btn-primary">Save</button>
                                </form>
                            </div>
                        </div>
                    </div>
