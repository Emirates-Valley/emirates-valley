            ...
            <div class="col-md-12">
                <div class="row">
                    <div class="col-md-6 offset-md-3">
                        <div class="card">
                            <div class="card-body">
                                <form method="Post" action="<?php echo base_url().'admin/logo/add'?>" enctype="multipart/form-data" onsubmit="$('.preloader').show();">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Website Name</label>
                                                <input type="text" class="form-control" value="<?php echo set_value('website_name')?>" name="website_name">
                                            </div>
                                    ...
                                    <br />
                                    <br />
                                    <button type="submit" name="add_logo" value="add_logo" class="btn btn-primary">Save</button>
                                </form>
                            </div>
                        </div>
                    </div>
